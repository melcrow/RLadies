...
4. Let's fine the average price per square foot in each of the four states in the data set using a grouped summary. Which state has the most expensive houses per square foot?
